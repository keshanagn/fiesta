...
<div id = "section5">
        <div id = "form1" class = "inline1">
            <form action="action.php" method = "get" >
                <p id = "signin">Sign In</p>  <br>      <!-- must be in 40px -->
                ...
                <p class = "as_para">As Admin</p>
                <p class = "as_para">As Customer</p><br><br>
                <input type="Submit" Value = "Sign In" class = "submitbtn">
                <input type="Submit" Value = "Sign In" >
            </form>
        </div>

        <div class = "inline1" id = "text1">
           <p>Want to manage <br>Your food business <br>easily?</p> 
           <p id = "Design">Our Design is very <br> User Friendly to <br> handle <br>feel free to get your orders <br> done correctly.</p>
        </div>
</div>
